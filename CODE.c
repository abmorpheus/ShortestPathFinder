...
// A function to insert new distances
...
//A function to modify existing data
...
// A  function to check if a given vertex 'v' is in min heap or not
...
{
    addEdge(graph, 0, 1, 237);
    addEdge(graph, 0, 2, 710);
    addEdge(graph, 0, 3, 663);
    addEdge(graph, 1, 2, 480);
    addEdge(graph, 1, 3, 441);
    addEdge(graph, 2, 3, 81);
    addEdge(graph, 4, 1, 611);
    addEdge(graph, 4, 2, 190);
    addEdge(graph, 4, 3, 270);
}
...
int main()
{
    ...
    char title[] = "SHORTEST DISTANCE CALCULATOR.................by Abhay";
    printf("\n\n");
